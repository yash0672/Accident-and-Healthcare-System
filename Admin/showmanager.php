...
<button type="submit" hover= ""onclick="window.location.href='mainpage.php'" name="logout" style="float:right;background-color:#000000">Back to Admin</button>
  </div>
</div>


<center><br><br><br><h1 style="font-size:70px;background-color: black;color: white;">SHOW MANAGER</h1><hr>
<?php
session_start();
