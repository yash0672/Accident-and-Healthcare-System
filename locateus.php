...
<body style="background-image:url(images/yellowpage.jpg)">
	<div class="header">
		<ul>
			<li style="float:left;border-right:none"><a href="ulogin.php" class="logo"><img src="images/logo.png" width="30px" height="30px"><strong> Accident HealthCare System </strong>Appointment Booking System</a></li>
